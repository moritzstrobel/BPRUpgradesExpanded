...
// Temporary high-value fire-rate effect for validating FireInterval behavior.
// Once confirmed in-game, this can be reduced to the intended final balance value.
...
// Preserve the AK's normal semi-auto and automatic modes and add a 3-round burst.
// FireQueueCount is configured on GunAK74_ST in the generated weapon patch.
...
def main() -> None:
    ...
    rendered_upgrades = [
        ...
        "// Fire-rate, reload-speed, caliber-conversion and burst-fire test nodes.",
        "",
    ]
