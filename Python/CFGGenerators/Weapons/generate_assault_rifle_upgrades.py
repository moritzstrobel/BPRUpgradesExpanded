...
def render_upgrade_patch(config: dict) -> str:
    lines = [
        ...
        "// -----------------------------------------------------------------------------",
        "",
        "// BPRUE master templates: keep the direct vanilla [0] inheritance in one place",
        "// and let all generated upgrades inherit through an explicit BPRUE prototype.",
        "",
        f"{UPGRADE_TEMPLATE_SID} : struct.begin {{refkey=[0]}}",
