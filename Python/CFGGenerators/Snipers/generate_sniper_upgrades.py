...
def main():
    ...
    outputs={UPGRADE_OUTPUT:render_upgrade_prototypes(model,source='sniper_upgrades.json',template_sid=TEMPLATE_SID,header_comments=('Three mutually-exclusive specialization groups plus one standalone family signature.',)),EFFECT_OUTPUT:render_effects(),WEAPON_OUTPUT:render_general_setup_patch(model,header_comments=('Vintar, GP3A and unique variants are intentionally excluded from this pass.',))}
