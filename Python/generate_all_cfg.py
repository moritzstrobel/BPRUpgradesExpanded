...
# Class generators create their source sections. Finalizers then consolidate the
# overlapping UpgradePrototype and GeneralSetup outputs. Module layout is applied
# in-memory by merge_upgrade_prototypes.py instead of rewriting intermediate CFGs.
GENERATORS = [
